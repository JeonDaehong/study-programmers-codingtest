...
// 풀이시간    : 2021-11-24 09:50 ~ 09:58
// 결과	  	   : 100.0 / 100.0 (정확성: 100.0)
// 나의 판단   : 처음에 answer를 long으로 둔 이유가 있었다. long은 int보다 더 큰 수를 다룰 수 있다.
...
public class Problem_023_MySolution01 {
	...
	public long solution(int price, int money, int count) {
        ...
        if (money < totalPrice) return totalPrice-money;
        else 					return 0;
